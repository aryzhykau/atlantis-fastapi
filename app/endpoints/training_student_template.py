...
def read_training_student_templates(db: Session = Depends(get_db)):
...
def read_training_student_template(student_template_id: int, db: Session = Depends(get_db)):
...
def create_training_student_template_endpoint(
        training_student_template: TrainingStudentTemplateCreate, db: Session = Depends(get_db)
):
...
def update_training_student_template_endpoint(
        student_template_id: int, training_student_template: TrainingStudentTemplateUpdate,
...
def delete_training_student_template_endpoint(student_template_id: int, db: Session = Depends(get_db)):
