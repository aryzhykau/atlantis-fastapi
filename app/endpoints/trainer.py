...
def create_trainer_endpoint(trainer_data: TrainerCreate, current_user = Depends(get_current_user(["ADMIN", "OWNER"])), db: Session = Depends(get_db)):
...
def get_trainer_endpoint(trainer_id: int, current_user = Depends(get_current_user(["ADMIN", "OWNER"])), db: Session = Depends(get_db)):
...
def update_trainer_endpoint(trainer_id: int, trainer_data: TrainerUpdate, current_user = Depends(get_current_user(["ADMIN", "OWNER"])), db: Session = Depends(get_db)):
...
def delete_trainer_endpoint(trainer_id: int, current_user = Depends(get_current_user(["ADMIN", "OWNER"])), db: Session = Depends(get_db)):
...
def update_trainer_status_endpoint(trainer_id: int, status_data: StatusUpdate, current_user = Depends(get_current_user(["ADMIN", "OWNER"])), db: Session = Depends(get_db)):
