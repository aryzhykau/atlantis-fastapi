...
Новые правки - телефон клиента с кодом страны + номер (указать что мобильный)
пофиксить датагрид добавить возможность перехождить на с раницы клиентов тренеров и учеников при клике на всю строкуубрать иконку плей из карточки абонемента на странице ученика
проверить и исправить заморозку
...
- в создании шаблонаи тренировки указывать не номер дня недели а название
